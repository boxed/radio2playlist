"""
Django settings for radio2playlist project.
...
ROOT_URLCONF = 'radio2playlist.urls'
...
WSGI_APPLICATION = 'radio2playlist.wsgi.application'


# Database
# https://docs.djangoproject.com/en/3.1/ref/settings/#databases

if os.environ.get('DOKKU_MYSQL_MYSQL_ENV_MYSQL_USER'):
    DATABASES = {
        'default': {
